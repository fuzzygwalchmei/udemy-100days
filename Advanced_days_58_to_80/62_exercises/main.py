...
class CafeForm(FlaskForm):
    ...
    power_outlet = SelectField('Power Outlets', choices=['✘','🔌','🔌🔌','🔌🔌🔌','🔌🔌🔌🔌','🔌🔌🔌🔌🔌'], validators=[DataRequired()])
...
def add_cafe():
    ...
    # with   if form.validate_on_submit()
        with open('cafe-data.csv','a') as csv_f:
            csv_f.write(f"\n{form.cafe.data},{form.location_url.data},{form.open.data},{form.close.data},"
            f"{form.coffee.data},{form.wifi.data},{form.power_outlet.data}")
